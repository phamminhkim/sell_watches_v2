      ...
      <div class="row">
        <div class="col-md-12">
          <div class="bg-white p-3">
            <b-table responsive="sm" striped hover small :bordered="true" :items="brands" :fields="fields"
              ...
              <form @submit.prevent="addBrand()">
                ...
                <div class="modal-body">
                  <div class="form-group row align-items-baseline">
                    ...
                    <div class="col-lg-8">
                      <input placeholder="Nhập mã" type="text" class="form-control" id="code" v-model="brand.code"
                  ...
                  <div class="form-group row align-items-baseline">
                    ...
                    <div class="col-lg-8">
                      <input placeholder="Nhập tên sản phẩm" type="text" class="form-control" id="name"
                        v-model="brand.name" name="name" v-bind:class="hasError('name') ? 'is-invalid' : ''" />
                  ...
                  <div class="form-group row align-items-baseline">
                    ...
                    <div class="col-lg-8">
                      <textarea placeholder="Nhập ghi chú" class="form-control" id="note" v-model="brand.note"></textarea>
                    </div>
                  </div>
                </div>
