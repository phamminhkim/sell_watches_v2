    ...
    <div>
        <div class="content">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="bg-white">
                        <b-table striped hover small :bordered="true" :items="products" :fields="fields" :filter="filter"
                            ...
                            <template #cell(action)="data">
                                ...
                                <button @click="deleteProduct(data.item.id)" class="btn btn-sm btn-danger"><i class="fa fa-minus mr-1 mt-1"></i>Xóa</button>
                            </template>
                        </b-table>
                        <div class="row">
                            <div class="col-md-12">
                            ...
                            <form @submit.prevent="addProduct()">
                                ...
                                <div class="modal-body">
                                    <div class="form-group row align-items-baseline">
                                        <div class="col-lg-4">
                                            <label class="font-weight-bold" for="code">Mã sản phẩm</label><small
                                                class="text-danger">*</small>
                                        </div>
                                        <div class="col-lg-8">
                                            <input placeholder="Nhập mã" type="text" class="form-control" id="code"
                                                v-model="product.code" name="code"
                                    ...
                                    <div class="form-group row align-items-baseline">
                                        <div class="col-lg-4">
                                            <label class="font-weight-bold" for="name">Tên sản phẩm</label><small
                                                class="text-danger">*</small>
                                        </div>
                                        <div class="col-lg-8">
                                            <input placeholder="Nhập tên sản phẩm" type="text" class="form-control"
                                                id="name" v-model="product.name" name="name"
                                    ...
                                    <div class="form-group row align-items-baseline">
                                        <div class="col-lg-4">
                                            <label class="font-weight-bold" for="note">Số tiền</label><small
                                            class="text-danger">*</small>
                                        </div>
                                        <div class="col-lg-8">
                                     ...
                                     <div class="form-group row align-items-baseline">
                                        <div class="col-lg-4">
                                            <label class="font-weight-bold" for="note">Số lượng</label><small
                                            class="text-danger">*</small>
                                        </div>
                                        <div class="col-lg-8">
                                      ...
                                      <div class="form-group row align-items-baseline">
                                        <div class="col-lg-4">
                                            <label class="font-weight-bold" for="note">Thượng hiệu</label><small
                                            class="text-danger">*</small>
                                        </div>
                                        <div class="col-lg-8">
                                    ...
                                    <div class="form-group row align-items-baseline">
                                        <div class="col-lg-4">
                                            <label class="font-weight-bold" for="note">Màu</label><small
                                            class="text-danger">*</small>
                                        </div>
                                        <div class="col-lg-8">
                                    ...
                                    <div class="form-group row align-items-baseline">
                                        <div class="col-lg-4">
                                            <label class="font-weight-bold" for="note">Danh mục</label><small
                                            class="text-danger">*</small>
                                        </div>
                                        <div class="col-lg-8">
                                    ...
                                    <div class="form-group row align-items-baseline">
                                        <div class="col-lg-4">
                                            <label class="font-weight-bold" for="note">Giới tính</label><small
                                            class="text-danger">*</small>
                                        </div>
                                        <div class="col-lg-8">
                                    ...
                                    <div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 mt-2 image" v-for="(image, index) in product.images"
                                                :key="index">
                                                <div class="img-ralative">
                                                    <img :src="image.path" class="w-100 img-responsive mt-2"
                                                        alt="Ảnh đã chọn" loading="lazy">
                                                    <button @click.prevent="deleteImage(index, image)"
