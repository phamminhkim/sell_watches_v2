    ...
    <div>
        <div class="container">
            <div class="form-group">
                <label class="font-weight-bold text-uppercase">Đơn mua</label>
            </div>
            <div class="form-group">
                <div class="form-group shadow p-4" v-for="(order, index) in orders" :key="index">
                    ...
                    <div class="form-group row">
                        <div class="col-lg-4">
                            <div class="form-group" v-for="order_detail in order.order_details">
                                <div class="form-group d-flex align-items-center justify-content-around"
                                    v-for="image in order_detail.product.images">
                        ...
                        <div class="col-lg-8">
                            ...
                            <p><button class="btn btn-danger rounded-pill"> {{ order.status }} </button> </p>
                        </div>
                    </div>
