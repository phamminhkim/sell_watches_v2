      ...
      <div class="row">
        <div class="col-md-12">
          <div class="bg-white p-3">
            <b-table responsive="sm" striped hover small :bordered="true" :items="categories" :fields="fields"
              ...
              <form @submit.prevent="addCategory()">
                ...
                <div class="modal-body">
                  <div class="form-group row align-items-baseline">
                    <div class="col-lg-4">
                      <label class="font-weight-bold" for="code">Mã danh mục</label><small class="text-danger">*</small>
                    </div>
                    <div class="col-lg-8">
                      <input placeholder="Nhập mã" type="text" class="form-control" id="code" v-model="category.code"
                  ...
                  <div class="form-group row align-items-baseline">
                    <div class="col-lg-4">
                      <label class="font-weight-bold" for="name">Tên danh mục</label><small class="text-danger">*</small>
                    </div>
                    <div class="col-lg-8">
                      <input placeholder="Nhập tên sản phẩm" type="text" class="form-control" id="name"
                        v-model="category.name" name="name" v-bind:class="hasError('name') ? 'is-invalid' : ''" />
